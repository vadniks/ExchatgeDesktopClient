...
//
///////////////////////////////////////////////////////////////////////////////
// The following code was taken directly from the Nuklear library and modified so that asterisks ('*')
// are displayed instead of the real characters of the input text, nothing more was modified,
// modifications are marked with '<--' at each modified line's end

static nk_flags nk_do_edit_password(
    nk_flags* state,
            ...
            {struct nk_color background_color;
                ...
                if (edit->select_start == edit->select_end) {
                    ...
                    nk_edit_draw_text(out, style, area.x - edit->scrollbar.x,
                                      area.y - edit->scrollbar.y, 0, mask/*begin*/, l, row_height, font, // <--
                    ...
                    if (edit->select_start != edit->select_end && selection_begin > 0){
                        ...
                        nk_edit_draw_text(out, style, area.x - edit->scrollbar.x,
                                          area.y - edit->scrollbar.y, 0, mask/*begin*/, (int)(select_begin_ptr - begin), // <--
                         ...
                         selection_end < edit->string.len))
                    {
                        ...
                        nk_edit_draw_text(out, style,
                                          ...
                                          mask/*begin*/, (int)(end - begin), row_height, font, // <--------
...
static nk_flags nk_edit_password_buffer(
    ...
    ret_flags = nk_do_edit_password(&ctx->last_widget_state, &win->buffer, bounds, flags, // <----------------
                           filter, edit, &style->edit, in, style->font, mask); // <--------------------------------
...
nk_flags nk_edit_password_string(
    ...
    *len = NK_MIN(*len, max-1);
    ...
    state = nk_edit_password_buffer(ctx, flags, edit, filter, mask); // <-----------------------------------------------
