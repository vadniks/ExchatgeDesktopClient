...
DatabaseMessage* databaseMessageCreate(unsigned long timestamp, unsigned from, const byte* text, unsigned size); // from (user id), the name of the sender otherwise; size of text, whereas size of from is known to all users of this api
