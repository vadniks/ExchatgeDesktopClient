...
__attribute_maybe_unused__ void* nullable queuePeek(Queue* queue); // returns the top value if the queue is not empty and null if it is but doesn't remove the top value
__attribute_maybe_unused__ void queueDropTop(Queue* queue); // drops the top value and deallocates it
